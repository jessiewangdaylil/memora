{{-- <div class="p-6 sm:px-20 bg-white border-b border-gray-200"> --}}
  <div class="p-6 sm:px-20  border-b" style="background-color:#f7eeda">
    <div>
...
<div class="bg-opacity-25 grid grid-cols-1 md:grid-cols-2" style="background-color:#d8918d">
    <div class="p-6">
        <div class="flex items-center">
            ...
            <div class="ml-4 text-lg text-gray-600 leading-7 font-semibold">
              <a href="https://laravel.com/docs">Documentation</a></div>
        </div>
